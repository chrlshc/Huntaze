...
declare namespace RDS {
  ...
  export interface StartDBInstanceAutomatedBackupsReplicationMessage {
    ...
    BackupRetentionPeriod?: IntegerOptional;
    /**
     * The Amazon Web Services KMS key identifier for encryption of the replicated automated backups. The KMS key ID is the Amazon Resource Name (ARN) for the KMS encryption key in the destination Amazon Web Services Region, for example, arn:aws:kms:us-east-1:123456789012:key/AKIA****************.
     */
    KmsKeyId?: String;
    /**
