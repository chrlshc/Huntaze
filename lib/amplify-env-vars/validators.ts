  ...
  static validateVariable(variable: EnvironmentVariable): ValidationResult {
    ...
    if (value && rules.minLength && value.length < rules.minLength) {
      results.push({
        isValid: false,
        variable: key,
        message: `Value too short. Minimum length: ${rules.minLength}`,
        severity: 'error'
      });
    }
    ...
    if (value && rules.maxLength && value.length > rules.maxLength) {
      results.push({
        isValid: false,
        variable: key,
        message: `Value too long. Maximum length: ${rules.maxLength}`,
        severity: 'error'
      });
    }
    ...
    return {
      isValid: true,
      variable: key,
      message: 'Variable validation passed',
      severity: 'success'
    };
  }
    ...
    switch (format) {
      ...
      default:
        return {
          isValid: true,
          variable: key,
          message: `Unknown format type: ${format}`,
          severity: 'warning'
        };
    }
  }
