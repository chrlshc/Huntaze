    ...
    <div className="min-h-screen bg-gray-900 text-white">
      ...
      <section className="relative py-20 px-4 overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto text-center">
          <Card className="inline-flex items-center gap-2 bg-purple-500/20 backdrop-blur-sm px-4 py-2 rounded-full mb-6">
      ...
      <section className="py-16 px-4">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12 mb-16">
            {/* What Others Do */}
            <Card className="bg-gray-800 rounded-2xl p-8 border border-gray-700">
            ...
            <div className="bg-gradient-to-br from-purple-900/50 to-pink-900/50 rounded-2xl p-8 border border-purple-500/50">
              ...
              <div className="space-y-3">
                <Card className="bg-gray-900/50 rounded-lg p-3 border border-green-500/30">
                  <p className="text-sm text-green-400">Starter</p>
                  <p className="font-bold">GPT-4 + GPT-3.5</p>
                </Card>
                <Card className="bg-gray-900/50 rounded-lg p-3 border border-purple-500/30">
                  <p className="text-sm text-purple-400">Pro</p>
                  <p className="font-bold">GPT-4-Turbo (All features)</p>
                </Card>
                <Card className="bg-gray-900/50 rounded-lg p-3 border border-blue-500/30">
                  <p className="text-sm text-blue-400">Scale</p>
                  <p className="font-bold">GPT-4-Turbo + Predictive</p>
                </Card>
                <Card className="bg-gray-900/50 rounded-lg p-3 border border-yellow-500/30">
          ...
          <div className="bg-gray-800 rounded-2xl p-8 space-y-8">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
              {/* Starter Response */}
              <Card className="bg-gray-900 rounded-xl p-6 border border-green-500/30">
              ...
              {/* Pro Response */}
              <Card className="bg-gray-900 rounded-xl p-6 border border-purple-500/30">
                <div className="flex items-center gap-2 mb-3">
              ...
              {/* Scale Response */}
              <Card className="bg-gray-900 rounded-xl p-6 border border-blue-500/30">
                <div className="flex items-center gap-2 mb-3">
              ...
              {/* Enterprise Response */}
              <Card className="bg-gray-900 rounded-xl p-6 border border-yellow-500/30">
                <div className="flex items-center gap-2 mb-3">
      ...
      <section className="py-16 px-4 bg-gray-800">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {/* Messaging Branch */}
            <Card className="bg-gray-900 rounded-xl p-6 border border-gray-700">
