              ...
              <div className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 bg-linear-to-br from-purple-600 to-pink-600 rounded-full"></div>
                    <div>
          ...
          >
            ...
            <div className="grid md:grid-cols-2 gap-x-12 gap-y-6">
              <div className="flex items-start gap-4">
                <svg className="w-6 h-6 text-purple-600 mt-0.5 shrink-0" fill="currentColor" viewBox="0 0 20 20">
