        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="elevated-card rounded-xl p-6">
            ...
            <ul className="list-disc pl-5 space-y-1 text-sm text-gray-700 dark:text-[var(--text-secondary-dark)]">
              <li>The AI provides response suggestions. You approve before sending.</li>
              <li>OnlyFans integration is read-only (CSV only for now).</li>
              <li>Respect each platform's terms of service. Huntaze is not affiliated with any platform.</li>
              <li>No guarantee of zero bans - we help reduce risks.</li>
              <li>AI API costs (OpenAI/Claude) are billed separately.</li>
            </ul>
          </div>
        </div>
      </div>
