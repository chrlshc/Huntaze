        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
              Custom AI training isn't available yet. This feature is coming soon.
            </p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 text-left max-w-md mx-auto">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-blue-900 dark:text-blue-100 mb-2">Arriving shortly:</p>
            ...
            <div className="mt-6 p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg max-w-md mx-auto">
              <p className="text-sm text-gray-700 dark:text-gray-300">
                <strong>Right now:</strong> The AI relies on pre-trained models that learn from your corrections and approvals over time.
              </p>
            </div>
