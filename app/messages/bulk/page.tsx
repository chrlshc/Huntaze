        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-6 max-w-md mx-auto">
              Bulk messaging isn't available yet. This feature is coming soon.
            </p>
            ...
            <div className="bg-blue-50 dark:bg-blue-900/20 rounded-lg p-6 text-left max-w-md mx-auto">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <p className="font-medium text-blue-900 dark:text-blue-100 mb-2">What's coming next:</p>
                  <ul className="space-y-1 text-sm text-blue-800 dark:text-blue-200">
                    <li>• Send messages to multiple fans</li>
                    <li>• Reusable templates</li>
                    <li>• Tag-based segmentation</li>
                    <li>• Scheduling outbound messages</li>
