...
export default function TestMockupPage() {
  return (
    <div className="min-h-screen bg-black text-white p-8">
      ...
      {/* Test Mobile Mockup */}
      <div className="relative w-full max-w-[420px] aspect-9/16 rounded-[22px] border border-white/20 bg-linear-to-br from-[#667eea] to-[#764ba2] overflow-hidden mx-auto">
        {/* Header */}
        <div className="bg-black/20 backdrop-blur-sm px-4 py-3 border-b border-white/10">
          <div className="flex items-center justify-between">
            ...
            <div className="h-8 w-8 rounded-full bg-linear-to-br from-pink-400 to-purple-400 flex items-center justify-center text-xs text-white font-bold">S</div>
          </div>
        </div>
        ...
        <div className="p-4">
          ...
          <div className="rounded-xl bg-white/10 backdrop-blur-md p-4 border border-white/20 mb-4">
            ...
            <div className="h-24 bg-linear-to-br from-green-400/20 to-green-600/20 rounded-lg mb-3"></div>
          ...
          <div className="grid grid-cols-2 gap-3">
            <div className="rounded-xl bg-linear-to-br from-purple-500/20 to-pink-500/20 backdrop-blur-md p-4 border border-purple-500/20">
            ...
            <div className="rounded-xl bg-linear-to-br from-blue-500/20 to-green-500/20 backdrop-blur-md p-4 border border-blue-500/20">
