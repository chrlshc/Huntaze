    ...
    <div className="min-h-screen bg-white dark:bg-gray-900 pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-700 dark:text-(--text-secondary-dark) max-w-2xl mx-auto">
        ...
        <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-6 mb-8">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-sm text-gray-600 dark:text-(--text-secondary-dark)">Overall Uptime</p>
          ...
          {services.map((service) => (
            <div key={service.name} className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
              <div className="flex items-start justify-between mb-4">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-(--text-secondary-dark)">{service.description}</p>
                  </div>
                </div>
              ...
              <div className="flex items-center justify-between text-sm">
                <span className="text-gray-600 dark:text-(--text-secondary-dark)">Uptime (30 days)</span>
        ...
        <div className="mt-12">
          ...
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-6 text-center">
            ...
            <p className="text-gray-700 dark:text-(--text-secondary-dark)">
        ...
        <div className="mt-12">
          ...
          <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-6">
            ...
            <p className="text-gray-700 dark:text-(--text-secondary-dark) mb-2">
        ...
        <div className="mt-12 text-center">
          <div className="bg-gray-50 dark:bg-gray-800 rounded-lg p-8 max-w-2xl mx-auto">
            ...
            <p className="text-gray-700 dark:text-(--text-secondary-dark) mb-6">
