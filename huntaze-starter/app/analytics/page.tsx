  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-8">
      ...
      <section className="mb-8">
        <h2 className="text-lg font-medium mb-3">By platform (since {since}, days loaded: {summary.rangeDays})</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          {Object.keys(summary.perPlatform).length === 0 && (
            <div className="rounded-lg border p-4 text-sm text-gray-500">No data for this period.</div>
          )}
        </div>
      </section>
    </main>
