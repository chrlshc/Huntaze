 ...
 * Usage: AWS_ACCESS_KEY_ID=xxx AWS_SECRET_ACCESS_KEY=xxx node scripts/check-amplify-status.js
 */
...
if (!process.env.AWS_ACCESS_KEY_ID || !process.env.AWS_SECRET_ACCESS_KEY) {
    ...
    console.log('\nUsage:');
    console.log('AWS_ACCESS_KEY_ID=xxx AWS_SECRET_ACCESS_KEY=xxx node scripts/check-amplify-status.js');
    console.log('\nOu pour les credentials temporaires:');
    console.log('AWS_ACCESS_KEY_ID=xxx AWS_SECRET_ACCESS_KEY=xxx AWS_SESSION_TOKEN=xxx node scripts/check-amplify-status.js');
    process.exit(1);
}
