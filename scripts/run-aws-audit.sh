...
if [ -z "$AWS_ACCESS_KEY_ID" ] || [ -z "$AWS_SECRET_ACCESS_KEY" ]; then
    ...
    echo "  export AWS_ACCESS_KEY_ID=REDACTED_access_key"
    echo "  export AWS_SECRET_ACCESS_KEY=REDACTED_secret_key"
    echo "  export AWS_SESSION_TOKEN=REDACTED_session_token (if using temporary credentials)"
