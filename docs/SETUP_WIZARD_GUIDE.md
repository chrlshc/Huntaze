...
**Persisted**: `primary_goal = "automate_messages"` (example)
...
| Tone | System prompt configuration |
|------|----------------------------|
...
**Persisted**: `ai_tone = "flirty"` (example), or `"professional"` when skipped.

---

## What happens after each answer

### Example flow: OnlyFans + Automate Messages + Skip Tone (defaults to Professional)
...
```json
{
  "user_id": "user_123456",
  "platform": "onlyfans",
  "primary_goal": "automate_messages",
  "ai_tone": "professional",
  "follower_range": "10k_50k",
  "onboarding_complete_at": "2025-11-11T20:00:35Z",
  "questions_skipped": [4],
  "time_to_complete": 35,
  "ai_config_json": {
    "tone": "professional",
...
| Questions | 3 required + 1 optional |
| Skip rate (acceptable) | < 30% on Step 4 |
| Activation rate | > 80% |
| Support tickets (Week 1) | < 5% of users |
...
For questions or feedback about the setup wizard:
- Email: support@huntaze.com
- Docs: https://docs.huntaze.com/setup-wizard
