...
const iconPaths: Record<string, { primary: string; secondary: string }> = {
  ...
  onlyfans: {
    ...
    secondary: 'M12 6c-3.31 0-6 2.69-6 6s2.69 6 6 6 6-2.69 6-6-2.69-6-6-6zm0 10c-2.21 0-4-1.79-4-4s1.79-4 4-4 4 1.79 4 4-1.79 4-4 4z',
  },
  marketing: {
    primary: 'M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3',
    secondary: 'M9 21v-6a2 2 0 012-2h2a2 2 0 012 2v6M12 7h.01',
  },
  settings: {
