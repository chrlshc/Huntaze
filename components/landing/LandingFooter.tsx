          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
            ...
            <div className="md:col-span-2">
              <div className="flex items-center gap-3 mb-4">
                <h3 className="text-white text-2xl font-bold bg-gradient-to-r from-indigo-400 to-purple-400 bg-clip-text text-transparent">
                  Huntaze
                </h3>
              ...
              <p className="text-gray-400 mb-6 max-w-md leading-relaxed">
                Empowering creators to grow their audience and monetize their content with AI-powered tools and analytics.
              </p>
            ...
            <div>
              ...
              <ul className="space-y-3">
                <li>
                  <Link href="/#features" className="hover:text-indigo-400 transition-colors flex items-center gap-2">
                    <span>Features</span>
                  </Link>
                </li>
                <li>
                  <Link href="/auth/register" className="hover:text-indigo-400 transition-colors flex items-center gap-2">
          ...
          <div className="pt-8 border-t border-gray-800">
            <div className="flex flex-col md:flex-row justify-between items-center gap-4">
              <p className="text-gray-400 text-sm">
                &copy; <SafeCurrentYear fallback={<span>2024</span>} /> Huntaze. All rights reserved.
              </p>
