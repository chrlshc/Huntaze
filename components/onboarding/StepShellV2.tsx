...
export function StepShellV2({
  ...
  return (
    <div className="min-h-dvh flex flex-col bg-linear-to-b from-background via-background to-background">
      ...
      <main className="flex-1">
        <div className="mx-auto w-full max-w-(--breakpoint-2xl) grid grid-cols-1 lg:grid-cols-12 gap-6 p-4">
      ...
      <footer className="sticky bottom-0 z-40 border-t backdrop-blur supports-[backdrop-filter]:bg-background/70">
        <div className="mx-auto max-w-(--breakpoint-2xl) px-4 py-3 flex items-center gap-2">
