      ...
      <div className="mt-auto">
        <div className="relative group flex justify-center">
          <button
            ...
            aria-label="Logout"
            className="relative flex h-12 w-12 items-center justify-center rounded-xl text-gray-400 transition-colors duration-150 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2 focus-visible:ring-offset-gray-900 hover:text-red-400"
          >
