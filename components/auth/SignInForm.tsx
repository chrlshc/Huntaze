 ...
 * 
 * Example implementation using the auth module
 */
...
export function SignInForm({ callbackUrl = '/dashboard' }: SignInFormProps) {
  ...
  const handleRecovery = () => {
    ...
    const recovery = getRecoveryAction(authError);
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div>
          ...
          <input
            ...
            disabled={isLoading}
            className="w-full px-4 py-2 border border-gray-300 dark:border-gray-600 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent disabled:opacity-50 disabled:cursor-not-allowed"
      ...
      <div className="mt-6">
        ...
        <div className="mt-6">
          <button
            ...
            disabled={isLoading}
            className="w-full py-3 px-4 border border-gray-300 dark:border-gray-600 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors flex items-center justify-center gap-3"
          >
