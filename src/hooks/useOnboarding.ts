...
export const availablePersonalities: AIPersonality[] = [
  {
    ...
    name: 'Flirty Premium',
    tone: 'flirty-premium',
    description: 'Sophisticated seductress with a touch of mystery',
    emojiPalette: ['😘', '💋', '🔥', '💕', '😈', '🌹'],
    boldnessLevel: 0.8,
  },
  {
    ...
    description: 'Warm and approachable, like a close friend',
    emojiPalette: ['😊', '💖', '🥰', '✨', '🌸', '💫'],
    boldnessLevel: 0.4,
  },
  {
    ...
    name: 'Playful Tease',
    tone: 'playful-tease',
    description: 'Playful and teasing, always with a smile',
    emojiPalette: ['😏', '😉', '💦', '🍑', '👅', '🎉'],
    boldnessLevel: 0.6,
  },
];
